...
const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}> {/*div samt chap header */}
    ...
    <div className={`flex-1 ${styles.flexEnd} flex-col xl:px-0 sm:px-16 px-6 relative`}> {/*div rast samt header */}
      <div className='flex flex-row items-center py-[6px] px-4 bg-dicount-gradient rounded-[10px] mb-2'> {/* neveshte kochik bala heder*/}
        <p className={`${styles.paragraph} ml-2 text-right`}>
          ...
          <span className='text-white'> 20% </span>
           اکانت
           <span className='text-white text-right'> 1 ماهه</span>
        </p>
      ...
      <div className='flex flex-row justify-between items-center w-full'>
        ...
        <h1 className='flex-1 text-right font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]'> راه حل جدید و <br className='sm:block hidden' /> {" "}
      ...
      تیم کارشناسان ما از روشی برای شناسایی کارت های اعتباری که به احتمال زیاد مطابق با نیازهای شما هستند، استفاده می کند. ما نرخ های درصد سالانه، هزینه های سالانه را بررسی می کنیم.
      </p>
